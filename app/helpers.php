 ...
 * About me
 */
if (!function_exists('ProfileAuthor')) {
...
if (!function_exists('single_latest_post')) {
    function single_latest_post(){
        return Post::with('postID')->limit(1)->orderBy('created_at','desc')->first();
    }
}
...
if (!function_exists('latest_home_6posts')) {
    function latest_home_6posts(){
        return Post::with('postID')->skip(1)->limit(6)->orderBy('created_at','desc')->get();
    }
}

/**
 * DISPLAY RANDOM POTST
 */
...
if (!function_exists('recommended_posts')) {
    function recommended_posts(){
        return Post::with('postID')->limit(4)->inRandomOrder()->get();
    }
}
