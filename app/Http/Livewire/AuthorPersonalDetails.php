...
class AuthorPersonalDetails extends Component
{
    ...
    public function UpdateDetails() {
        ...
        $this->showToastr('Your Profile info have been successfully updated.', 'success'); // show showToastr message
    }

    public function showToastr($message, $type) { // show showToastr message
