...
class AuthorForgotForm extends Component
{
    ...
    public function ForgotHandler() {
        ...
        $body_message = "We are received a request to reset the password for <b>jinnapat</b> account associated with ". $this->email.". <br> You can reset your password by clicking the button below.";
        $body_message.='<br>';
        ...
        Mail::send('forgot-email-template', $data, function($message) use ($user) {
            $message->from('noreply@example.com', 'jinnapat');
