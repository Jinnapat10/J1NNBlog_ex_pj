                    ...
                    <div class="col-md-6 mb-4">
                        <article class="card article-card article-card-sm h-100">
                            ...
                            <div class="card-body px-0 pb-0">
                                ...
                                <h2><a class="post-title" href="{{ route('read_post', $item) }}">{{ $item->post_title }}</a>
                                </h2>
                                <p class="card-text">{!! Str::ucfirst(words($item->post_content, 12)) !!}</p>
                                <div class="content"> <a class="read-more-btn" href="{{ route('read_post', $item) }}">Read
                                        Full Article</a>
                                </div>
                            </div>
                        </article>
